    ...
    <header b-dk557gbzy5="" class="m-1 rounded-md p-2 shadow-md shadow-gray-500">
        ...
        <main b-dk557gbzy5="" role="main" class="w-full px-4 pt-2">
        	<section class="flex min-h-dvh w-full flex-col items-center">
			    <h2 class="w-full bg-gray-900 p-4 text-center text-6xl font-bold text-gray-50">Editar Reserva</h2>
			    <form class="flex h-full w-2/3 flex-col items-center justify-center rounded-md py-4" method="POST" action="/Reserve/Search">
			        ...
			        <div class="flex w-2/3 flex-col self-center">
			            ...
			            <input type="date" class="border-2 mx-1 rounded-md border-gray-900 p-1" data-val="true" data-val-required="The Fecha de Fin de Reserva field is required." id="EndDate" name="EndDate" value=""><input name="__Invariant" type="hidden" value="EndDate">
			        ...
			        <div class="flex w-2/3 flex-col self-center">
			            ...
			            <input type="number" class="border-2 mx-1 rounded-md border-gray-900 p-1" data-val="true" data-val-required="Hora de inicio" id="Hour" name="Hour" value=""><input name="__Invariant" type="hidden" value="Hour">
			        ...
			        <div class="flex w-2/3 justify-between">
			            <button type="submit" class="mt-4 w-48 rounded-md border border-transparent bg-gradient-to-tr from-blue-800 to-blue-700 px-4 py-2 text-center text-sm text-white shadow-md transition-all hover:shadow-lg hover:bg-slate-700 focus:bg-slate-700 focus:shadow-none active:bg-slate-700 active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
			                <i class="fa fa-search" aria-hidden="true"></i>  Editar
			            </button>
			    	...
			    	<input name="__RequestVerificationToken" type="hidden" value="CfDJ8PsupENnyaxJsSE9YBIZHT7KXYvcMc_zF1VYpgaCe-h5JV6pqCzMe5kMmDr4lrGWPOky4NPJJpZq5vvFHCuYiyb6d6VTppdlkcImRXg1JK-yruq5wLbS85ChIISw9L8v0blpiiMC9aRlBSisWeNZUno"></form>
				    ...
				    <input name="__RequestVerificationToken" type="hidden" value="CfDJ8PsupENnyaxJsSE9YBIZHT7KXYvcMc_zF1VYpgaCe-h5JV6pqCzMe5kMmDr4lrGWPOky4NPJJpZq5vvFHCuYiyb6d6VTppdlkcImRXg1JK-yruq5wLbS85ChIISw9L8v0blpiiMC9aRlBSisWeNZUno">
				    </tr>
				    </tbody>
				    </table>
